      ...
      <SectionCard title="Đối tượng phân tích: Coca-Cola & Pepsi" icon={<Target className="text-green-500" />}>
        ...
        <div className="bg-slate-100 p-5 rounded-xl text-slate-800 mt-6 border-l-4 border-marx-red shadow-sm">
          <p className="mb-2 leading-relaxed">
            <strong>Theo Lênin</strong>, tư bản tài chính là sự hợp nhất giữa tư bản độc quyền ngân hàng và tư bản độc quyền công nghiệp. Giáo trình nhấn mạnh sự ra đời "biểu hiện mới" là các <strong>"tập đoàn tài chính quốc tế"</strong> và <strong>"trung tâm tài chính thế giới"</strong>.
          </p>
